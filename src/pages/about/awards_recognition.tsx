const Awards_Recognition = () => {
  ...
  return (
    <>
      <div className="min-h-screen mx-auto flex flex-col lg:flex-row items-center justify-center max-w-[1284px] my-[100px] md:my-[140px] md:mb-[180px] px-4">
        <div className="w-full">
          ...
          <div>
            {info.map((i, index) => (
              ...
              >
                <p className="md:w-[20%] w-[100%]">
                  Best Interior Design Agency
                </p>
                <p className="md:w-[30%] w-[100%]">
                  Awarded for outstanding innovation in interior design concepts
                </p>
                <p className="w-full md:w-min">2025</p>
              </div>
            ))}
          </div>
        </div>
